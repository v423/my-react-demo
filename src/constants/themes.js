...
export const THEMES = {
  ...
  ethereal: createTheme(BASE_THEME, {
    ...
    bgApp: 'bg-[#fdfbf7]',
    bgPanel: 'bg-white/80',
    textMain: 'text-[#3a3a3a]',
    textMuted: 'text-[#6a6a6a]',
    primary: 'bg-[#d6d2cd] text-[#2a2a2a] hover:bg-[#c4bfb9]',
    border: 'border border-[#e6e2dd]',
    corners: 'rounded-sm',
    inputStyle: 'bg-white/60 border border-[#e6e2dd] text-[#3a3a3a]',
    effects: { clean: true },
  }),
  ...
  'light-academia': createTheme(BASE_THEME, {
    ...
    bgApp: 'bg-[#f5f5dc]',
    bgPanel: 'bg-[#fffaf0]',
    textMain: 'text-[#4d3027]',
    textMuted: 'text-[#7d6057]',
    primary: 'bg-[#c7bbb8] text-[#3d2017] hover:bg-[#b7aba8]',
    border: 'border border-[#e7dcc8]',
    corners: 'rounded-sm',
    inputStyle: 'bg-white border border-[#d7ccc8] text-[#4d3027]',
    effects: { vintage: true },
  }),
  'wabi-sabi': createTheme(BASE_THEME, {
    ...
    bgApp: 'bg-[#dcd5c9]',
    bgPanel: 'bg-[#ebe5ce]',
    textMain: 'text-[#3d3b34]',
    textMuted: 'text-[#6d6b64]',
    primary: 'bg-[#6c6a65] text-[#ebe5ce] rounded-full px-6 hover:bg-[#5c5a55]',
    border: 'border border-[#a8a49b]',
    corners: 'rounded-xl rounded-tr-sm rounded-bl-sm',
    shadow: 'shadow-sm',
    inputStyle: 'bg-[#f0ece2] border border-[#b8b4ab] text-[#3d3b34]',
    effects: { organic: true },
  }),
  japandi: createTheme(BASE_THEME, {
    bgApp: 'bg-[#f4f1ea]',
    bgPanel: 'bg-white',
    textMain: 'text-[#1b1b1b]',
    textMuted: 'text-[#5b5b5b]',
    primary: 'bg-[#1b1b1b] text-white hover:bg-[#333]',
    border: 'border border-[#d0d0d0]',
    corners: 'rounded-lg',
    shadow: 'shadow-sm',
    inputStyle: 'bg-[#f9f9f9] border border-[#ddd] text-[#1b1b1b]',
    effects: { clean: true },
  }),
  ...
  coquette: createTheme(BASE_THEME, {
    ...
    textMain: 'text-[#8b4789]',
    textMuted: 'text-[#b87db6]',
    primary: 'bg-[#e89be5] text-white hover:bg-[#d88bd5]',
    border: 'border border-[#ffc0cb]',
    corners: 'rounded-xl',
    shadow: 'shadow-sm',
    inputStyle: 'bg-white border border-[#ffc0cb] text-[#8b4789]',
    effects: { soft: true },
  }),
