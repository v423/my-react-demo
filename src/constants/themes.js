...
export const STYLE_INFO = {
  default: {
    ...
    chars: ['清晰的层�?, '适度的留�?, '柔和的圆�?, '微妙的阴�?],
  },
  skeuomorphism: {
    title_zh: '拟物�?,
    desc: '模仿现实世界的纹理和光影，让数字界面感觉熟悉和可触摸�?,
    chars: ['模仿现实材质', '丰富的阴�?, '高光反射', '亲切�?],
  },
  'flat-design': {
    title_zh: '扁平化设�?,
    desc: '去除了所�?3D 效果，强调极简、色彩和排版，追求极致的数字原生效能�?,
    chars: ['无阴�?, '大色�?, '简洁图�?, '强调排版'],
  },
  'material-design': {
    title_zh: '材料设计',
  ...
  '90s-web': {
    ...
    chars: ['框架�?, '大理石纹�?, 'GIF动画', 'WordArt'],
  },
  'dark-academia': {
    title_zh: '暗黑学院�?,
    desc: '浪漫化了19世纪的学术生活、哥特建筑和古典文学�?,
    chars: ['深咖�?, '皮革质感', '古典衬线�?, '希腊雕塑'],
  },
  'light-academia': {
    title_zh: '浅色学院�?,
  ...
  museumcore: {
    ...
    chars: ['金色画框', '深红天鹅�?, '古典字体', '精细标签'],
  },
  'nature-distilled': {
    title_zh: '自然萃取',
    desc: '强调泥土、木材、皮肤的自然色调与质感，布局使用有机曲线�?,
    chars: ['自然配色', '墨迹效果', '颗粒�?, '有机曲线'],
  },
  // Fallback generics
  aurora: {
    title_zh: '极光风格',
    desc: '使用柔和、模糊、多彩的渐变背景，营造出梦幻和空灵的氛围�?,
    chars: ['多彩渐变', '柔和模糊', '有机形状', '梦幻�?],
  },
  ethereal: {
    title_zh: '空灵风格',
  ...
  'modern-nostalgia': {
    ...
    chars: ['复古字体', '暖色�?, '现代布局', '胶片质感'],
  },
  synthwave: {
    title_zh: '合成器浪�?,
    desc: '�?80 年代科幻和电子音乐启发，使用霓虹色、网格和深色背景�?,
    chars: ['霓虹�?, '网格', '深紫背景', '80年代'],
  },
  vaporwave: {
    title_zh: '蒸汽�?,
  ...
  steampunk: {
    ...
    chars: ['黄铜�?, '齿轮元素', '复古机械', '皮革质感'],
  },
  cybercore: {
    title_zh: '赛博�?,
    desc: '高科技低生活，黑客界面、霓虹绿、故障效果和黑暗背景�?,
    chars: ['黑客�?, '故障效果', '高科技', '黑暗背景'],
  },
  'art-deco': {
    title_zh: '装饰艺术',
  ...
  'pop-art': {
    ...
    chars: ['鲜艳色彩', '波点', '漫画�?, '重复图案'],
  },
  'swiss-punk': {
    title_zh: '瑞士朋克',
    desc: '打破瑞士设计的网格规则，使用倾斜、重叠和混乱的排版�?,
    chars: ['打破网格', '倾斜排版', '混乱�?, '实验�?],
  },
  neoclassicism: {
    title_zh: '新古典主�?,
  ...
  'pixel-art': {
    title_zh: '像素艺术',
    desc: '8 �?16 位游戏风格，低分辨率块状图形，怀旧而独特�?,
    chars: ['像素�?, '怀�?, '游戏�?, '块状'],
  },
  'concept-sketch': {
    title_zh: '概念草图',
